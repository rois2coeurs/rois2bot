...
client.on('message', message => {
    if(message.content === 'r!help'){
        ...
        help.addField(":arrow_forward: r!botinfo", "Quelques informations utiles sur le robot")
        help.addField(":arrow_forward: r!userinfo", "Quelques informations sur vous-même")
    ...
    //commande r!botinfo
      ...
      var botinfo = new Discord.RichEmbed()
        ...
        .addField(":desktop: Autres serveurs sur lesquels le robot est en ligne" , `**${client.guilds.size}** serveur`)
        .setColor("#ff5c33")
